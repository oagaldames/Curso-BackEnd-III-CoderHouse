...
export class PetsController {
  ...
  getAllPets = async (req, res, next) => {
    try {
      ...
      error.path = "[GET] api/pets - Class PetsController.getAllPets";
      next(error);
    }
  };
  ...
  createPet = async (req, res, next) => {
    try {
      ...
      error.path = "[POST] api/pets - Class PetsController.createPet";
      next(error);
    }
  };
  ...
  updatePet = async (req, res, next) => {
    try {
      ...
      error.path = "[PUT] api/pets/:pid - Class PetsController.updatePet";
      next(error);
    }
  };
  ...
  deletePet = async (req, res, next) => {
    try {
      ...
      error.path = "[DELETE] api/pets/:pid - Class PetsController.deletePet";
      next(error);
    }
  };
  ...
  createPetWithImage = async (req, res, next) => {
    try {
      ...
      error.path = "[POST] api/withimage - Class PetsController.createPetWithImage";
      next(error);
    }
  };
}
